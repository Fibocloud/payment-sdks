...
func (q *qpay_auth) httpRequestQPay(body interface{}, api utils.API, urlExt string) (response []byte, err error) {
...
func (q *qpay_auth) authQPayV2() (authRes qpayLoginResponse, err error) {
...
func (q *qpay_auth) refreshToken() (authRes qpayLoginResponse, err error) {
